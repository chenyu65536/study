...
public class Q1333 {
    ...
    public List<Integer> filterRestaurants(int[][] restaurants, int veganFriendly, int maxPrice, int maxDistance) {
        ...
        return Arrays.stream(restaurants).filter(restaurant -> veganFriendly <= restaurant[2]
    ...
    public static void main(String[] args) {
        ...
        Q1333 q1333 = new Q1333();
        List<Integer> rs = q1333.filterRestaurants(restaurants,veganFriendly,maxPrice,maxDistance);
